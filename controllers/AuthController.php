...
class AuthController extends Controller
{
    ...
    public function registro(): void
    {
        ...
        $form = [
            ...
            'empresa' => trim((string) ($_POST['empresa'] ?? 'onix')),
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $empresa = strtolower($form['empresa']);
            $nombre = $form['nombre'];
            ...
            $this->flash('error', 'Seleccione una empresa válida.');
            ...
            try {
                ...
                Usuario::crear($pdo, $cedula, $nombre, $usuarioLogin, $hash, 'asesor', $email, $empresa, 'activo');
            }
